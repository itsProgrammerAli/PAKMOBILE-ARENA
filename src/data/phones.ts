...
export const PHONES_DATA: PhoneSpec[] = [
  {
    ...
    brand: 'Samsung',
    model: 'Galaxy S24 Ultra 5G (12GB/512GB)',
    pricePKR: 399999,
    officialPricePKR: 434999,
    marketPriceRangePKR: { min: 364999, max: 419999 },
    variants: [
      {
        id: 's24u-12-256',
        name: '12GB / 256GB',
        ...
        marketPriceRangePKR: { min: 349999, max: 379999 },
      },
      {
        id: 's24u-12-512',
        name: '12GB / 512GB',
    ...
    specs: {
      ...
      storage: '512 GB UFS 4.0 High-Speed Internal Storage',
  ...
  },
  {
    ...
    marketPriceRangePKR: { min: 118999, max: 132999 },
    variants: [
      {
        id: 'a55-8-128',
        name: '8GB / 128GB',
        ...
        marketPriceRangePKR: { min: 109999, max: 119999 },
      },
      {
        id: 'a55-8-256',
        name: '8GB / 256GB',
      ...
      },
      {
        id: 'a55-12-256',
        name: '12GB / 256GB',
        ram: '12 GB (+ 8 GB RAM Plus virtual memory = 20GB)',
        storage: '256 GB built-in (microSD Card Slot supported up to 1TB via shared SIM slot)',
        pricePKR: 134999,
        officialPricePKR: 149999,
        marketPriceRangePKR: { min: 128999, max: 142999 },
      },
    ],
    ptaTax: {
