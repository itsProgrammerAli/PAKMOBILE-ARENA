...
export const BRANDS: BrandInfo[] = [
  ...
  { name: 'Samsung', count: 6, logoText: 'SAMSUNG', slug: 'samsung' },
  { name: 'Xiaomi', count: 3, logoText: 'XIAOMI', slug: 'xiaomi' },
  { name: 'Tecno', count: 3, logoText: 'TECNO', slug: 'tecno' },
  { name: 'Vivo', count: 3, logoText: 'VIVO', slug: 'vivo' },
  { name: 'Infinix', count: 3, logoText: 'INFINIX', slug: 'infinix' },
