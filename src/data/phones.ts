...
export const PHONES_DATA: PhoneSpec[] = [
  {
    ...
    brand: 'Apple',
    model: 'iPhone 15 Pro Max (8GB/256GB)',
    pricePKR: 479999,
    officialPricePKR: 524999,
    marketPriceRangePKR: { min: 459999, max: 495000 },
    variants: [
      {
        id: 'iphone15pm-8-256',
        name: '8GB / 256GB',
        ram: '8 GB LPDDR5 Unified Memory',
        storage: '256 GB NVMe ultra-fast solid state storage',
        pricePKR: 479999,
        officialPricePKR: 524999,
        marketPriceRangePKR: { min: 459999, max: 495000 },
      },
      {
        ...
        name: '8GB / 512GB',
        ram: '8 GB LPDDR5 Unified Memory',
        storage: '512 GB NVMe ultra-fast solid state storage',
        pricePKR: 539999,
        officialPricePKR: 584999,
        marketPriceRangePKR: { min: 519999, max: 559000 },
      },
      {
        id: 'iphone15pm-8-1tb',
        name: '8GB / 1TB',
        ram: '8 GB LPDDR5 Unified Memory',
        storage: '1 TB (1024 GB) NVMe Enterprise Storage with ProRes Log 4K60 direct recording',
        pricePKR: 614999,
        officialPricePKR: 659999,
        marketPriceRangePKR: { min: 589999, max: 635000 },
      },
    ],
    ptaTax: {
    ...
    specs: {
      ...
      ram: '8 GB LPDDR5 Unified High-Speed RAM',
      ...
      network: '5G Dual eSIM / Nano-SIM + eSIM (Global/Pakistani models), Aerospace-grade Grade 5 Titanium Frame with Textured Matte Glass Back, Action Button, USB-C 3.0 (up to 10Gbps transfer speed with DisplayPort output), IP68 Dust/Water Resistant (6m for 30 mins), Stereo Dual Speakers with Spatial Audio',
    },
  ...
  },
  {
    ...
    brand: 'Samsung',
    model: 'Galaxy S24 Ultra 5G (12GB/256GB)',
    pricePKR: 359999,
  ...
  },
  {
    ...
    tags: ['trending', 'camera', 'gaming', 'flagship'],
    specs: {
  ...
  },
  {
    ...
    rating: 0.0,
    reviewCount: 0,
    image: 'https://images.priceoye.pk/infinix-note-40-pro-pakistan-priceoye-79011-500x500.webp',
    tags: ['trending', 'budget', 'camera', 'gaming'],
    specs: {
    ...
    colorImages: {
      'Vintage Green': 'https://images.priceoye.pk/infinix-note-40-pro-pakistan-priceoye-79011-500x500.webp',
      'Titan Gold': 'https://images.priceoye.pk/infinix-note-40-pro-pakistan-priceoye-y58l7-500x500.webp',
    },
    colorHexes: {
  ...
  },
  {
    ...
    marketPriceRangePKR: { min: 132999, max: 144999 },
    variants: [
      {
        id: 'vivo-v30-12-256',
        name: '12GB / 256GB',
    ...
    rating: 0.0,
    reviewCount: 0,
    image: 'https://images.priceoye.pk/vivo-v30-pakistan-priceoye-8d07v-500x500.webp',
    tags: ['trending', 'camera', 'flagship'],
    specs: {
    ...
    colors: ['Peacock Green', 'Waving Aqua', 'Noble Black'],
    colorImages: {
      'Peacock Green': 'https://images.priceoye.pk/vivo-v30-pakistan-priceoye-8d07v-500x500.webp',
      'Waving Aqua': 'https://images.priceoye.pk/vivo-v30-pakistan-priceoye-6p75g-500x500.webp',
      'Noble Black': 'https://images.priceoye.pk/vivo-v30-pakistan-priceoye-c2g8l-500x500.webp',
    },
    colorHexes: {
