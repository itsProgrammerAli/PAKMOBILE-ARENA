        ...
        {comparedPhones.length === 0 ? (
          ...
          <div className="space-y-5 sm:space-y-8">
            ...
            <div className="grid grid-cols-2 gap-2.5 sm:gap-6">
              ...
              {/* Device 1 Card */}
              {phone1 && (
                <div className="relative rounded-2xl sm:rounded-3xl bg-white dark:bg-white/5 dark:backdrop-blur-xl border border-gray-200 dark:border-white/10 p-2.5 sm:p-5 shadow-xs sm:shadow-sm dark:shadow-2xl flex flex-col items-center text-center group hover:shadow-md dark:hover:shadow-emerald-950/30 transition-all">
                  <button
                    onClick={() => onRemovePhone(phone1.id)}
                    className="absolute top-2 right-2 sm:top-3 sm:right-3 p-1 sm:p-1.5 rounded-lg text-gray-400 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/50 transition-colors border border-transparent hover:border-rose-200 dark:hover:border-rose-800 z-10"
                  ...
                  <div className="w-full h-24 sm:h-40 flex items-center justify-center mb-2 sm:mb-3 bg-gray-50 dark:bg-white/5 rounded-xl sm:rounded-2xl p-1.5 sm:p-3 border border-gray-100 dark:border-white/5">
                    <img 
                      src={phone1.image} 
                      alt={phone1.name} 
                      className="max-h-20 sm:max-h-32 w-auto object-contain drop-shadow-sm dark:drop-shadow-[0_10px_20px_rgba(0,0,0,0.5)] group-hover:scale-105 transition-transform"
                      referrerPolicy="no-referrer"
                    />
                  </div>

                  <span className="px-2 py-0.2 sm:px-2.5 sm:py-0.5 rounded-full text-[9px] sm:text-[10px] font-bold uppercase tracking-wider bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800/60 mb-1">
                    {phone1.brand}
                  </span>

                  <h3 className="text-xs sm:text-base font-bold text-gray-900 dark:text-white font-['Outfit'] mb-0.5 line-clamp-1 w-full">
                    {phone1.name}
                  </h3>
                  <p className="text-[10px] sm:text-xs text-gray-500 dark:text-zinc-400 mb-2 line-clamp-1 w-full">
                    {phone1.model}
                  </p>

                  <div className="w-full py-1.5 sm:py-2.5 px-2 sm:px-3 rounded-lg sm:rounded-xl bg-emerald-50/70 dark:bg-emerald-950/40 border border-emerald-100 dark:border-emerald-800/50 mb-2 sm:mb-3">
                    <div className="text-[9px] sm:text-[11px] text-gray-500 dark:text-zinc-400 font-medium">Estimated PKR</div>
                    <div className="text-xs sm:text-lg font-extrabold text-emerald-700 dark:text-emerald-400 font-mono leading-tight">
                      {formatPKR(phone1.pricePKR)}
                    </div>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 sm:gap-2 w-full mt-auto">
                    <button
                      onClick={() => onSelectPhone(phone1)}
                      className="py-1.5 sm:py-2 px-1.5 sm:px-3 rounded-lg sm:rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-[10px] sm:text-xs font-bold transition-all shadow-xs flex items-center justify-center gap-1"
                    >
                    ...
                    <button
                      ...
                      className="py-1.5 sm:py-2 px-1.5 sm:px-3 rounded-lg sm:rounded-xl bg-white dark:bg-white/5 hover:bg-gray-50 dark:hover:bg-white/10 border border-gray-200 dark:border-white/10 text-gray-700 dark:text-zinc-300 text-[10px] sm:text-xs font-semibold transition-all flex items-center justify-center gap-1"
                    >
              ...
              {phone2 ? (
                ...
                <div 
                  ref={slotSearchRef} 
                  className="rounded-2xl sm:rounded-3xl border-2 border-dashed border-emerald-300/80 dark:border-emerald-700/80 bg-emerald-50/20 dark:bg-emerald-950/20 p-2.5 sm:p-5 flex flex-col items-center justify-center text-center relative"
                >
                  <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-emerald-100/70 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-400 flex items-center justify-center mb-1.5 sm:mb-2 shadow-2xs border border-emerald-200 dark:border-emerald-800/60">
                    <Plus className="w-5 h-5 sm:w-6 sm:h-6" />
                  </div>
                  <h4 className="text-xs sm:text-base font-bold text-gray-900 dark:text-white mb-0.5 sm:mb-1 font-['Outfit']">
                    Add 2nd Phone
                  </h4>
                  <p className="hidden sm:block text-[11px] text-gray-500 dark:text-zinc-400 mb-3 max-w-xs leading-relaxed">
                    Search and pick any device for direct 1v1 comparison.
                  </p>
                  
                  {/* Search Input for Slot */}
                  <div className="w-full max-w-xs relative text-left mt-1 sm:mt-0">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-7 sm:pl-8 pr-6 sm:pr-7 py-1.5 sm:py-2.5 bg-white dark:bg-zinc-900 border border-gray-300 dark:border-white/10 focus:border-emerald-600 dark:focus:border-emerald-500 rounded-xl text-[11px] sm:text-xs font-semibold text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-zinc-500 focus:outline-none shadow-2xs transition-all"
                      />
                      {slotSearchTerm && (
                        <button
                          onClick={() => {
                        ...
                        {filteredSlotPhones.length === 0 ? (
                          ...
                          filteredSlotPhones.map((p) => (
                            <button
                              ...
                              className="w-full p-2 hover:bg-emerald-50 dark:hover:bg-white/5 flex items-center justify-between text-left transition-colors group"
                            >
                              <div className="flex items-center gap-2 min-w-0">
                                ...
                                />
                                <div className="min-w-0">
                                  <div className="text-[11px] sm:text-xs font-bold text-gray-900 dark:text-white group-hover:text-emerald-700 dark:group-hover:text-emerald-400 truncate">
                                    {p.name}
                                  </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="rounded-2xl sm:rounded-3xl bg-white dark:bg-white/5 dark:backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-2xl overflow-hidden">
                <div className="px-4 sm:px-6 py-3 sm:py-4 bg-gray-50/80 dark:bg-white/5 border-b border-gray-200 dark:border-white/10 flex items-center justify-center sm:justify-start gap-2">
                  <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-emerald-100 dark:bg-emerald-950/80 text-emerald-700 dark:text-emerald-400 flex items-center justify-center flex-shrink-0">
                    <TrendingUp className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                  </div>
                  <h3 className="text-xs sm:text-sm font-bold uppercase tracking-wider text-gray-900 dark:text-white font-['Outfit']">
                ...
                <div className="p-3 sm:p-5 space-y-3 sm:space-y-4">
                  ...
                  <div className="border-b border-gray-200 dark:border-white/10 pb-3">
                    <div className="w-full text-center text-[10px] sm:text-xs font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-wider mb-1.5">
                      Estimated Market Price (PKR)
                    </div>
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 font-mono font-extrabold text-emerald-700 dark:text-emerald-400 text-xs sm:text-base">
                        {phone1 ? formatPKR(phone1.pricePKR) : '-'}
                      </div>
                      <div className="px-2 font-mono font-extrabold text-emerald-700 dark:text-emerald-400 text-xs sm:text-base">
                        {phone2 ? formatPKR(phone2.pricePKR) : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">Add 2nd Phone</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-b border-gray-200 dark:border-white/10 pb-3">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 font-mono font-bold text-gray-800 dark:text-zinc-200 text-[11px] sm:text-sm">
                        {phone1 ? (phone1.officialPricePKR ? formatPKR(phone1.officialPricePKR) : 'Market Imported') : '-'}
                      </div>
                      <div className="px-2 font-mono font-bold text-gray-800 dark:text-zinc-200 text-[11px] sm:text-sm">
                        {phone2 ? (phone2.officialPricePKR ? formatPKR(phone2.officialPricePKR) : 'Market Imported') : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-b border-gray-200 dark:border-white/10 pb-3">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 font-mono text-gray-600 dark:text-zinc-400 text-[11px] sm:text-xs">
                        {phone1 ? `${formatPKR(phone1.marketPriceRangePKR.min)} – ${formatPKR(phone1.marketPriceRangePKR.max)}` : '-'}
                      </div>
                      <div className="px-2 font-mono text-gray-600 dark:text-zinc-400 text-[11px] sm:text-xs">
                        {phone2 ? `${formatPKR(phone2.marketPriceRangePKR.min)} – ${formatPKR(phone2.marketPriceRangePKR.max)}` : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pb-1">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 text-gray-800 dark:text-zinc-200 font-medium text-[11px] sm:text-xs">
                        {phone1 ? phone1.releaseDate : '-'}
                      </div>
                      <div className="px-2 text-gray-800 dark:text-zinc-200 font-medium text-[11px] sm:text-xs">
                        {phone2 ? phone2.releaseDate : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
              ...
              <div className="rounded-2xl sm:rounded-3xl bg-white dark:bg-white/5 dark:backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-2xl overflow-hidden">
                ...
                <div className="p-3 sm:p-5 space-y-3 sm:space-y-4">
                  ...
                  <div className="border-b border-gray-200 dark:border-white/10 pb-3">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 font-mono font-bold text-emerald-700 dark:text-emerald-400 text-xs sm:text-sm">
                        {phone1 ? formatPKR(phone1.ptaTax.passportTaxPKR) : '-'}
                      </div>
                      <div className="px-2 font-mono font-bold text-emerald-700 dark:text-emerald-400 text-xs sm:text-sm">
                        {phone2 ? formatPKR(phone2.ptaTax.passportTaxPKR) : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-b border-gray-200 dark:border-white/10 pb-3">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 font-mono font-bold text-gray-900 dark:text-white text-xs sm:text-sm">
                        {phone1 ? formatPKR(phone1.ptaTax.cnicTaxPKR) : '-'}
                      </div>
                      <div className="px-2 font-mono font-bold text-gray-900 dark:text-white text-xs sm:text-sm">
                        {phone2 ? formatPKR(phone2.ptaTax.cnicTaxPKR) : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pb-1">
                    <div className="w-full text-center text-[10px] sm:text-xs font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-wider mb-1.5">
                      FBR Tax Slab Category
                    </div>
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 text-gray-700 dark:text-zinc-300 text-[11px] sm:text-xs">
                        {phone1 ? phone1.ptaTax.taxSlab : '-'}
                      </div>
                      <div className="px-2 text-gray-700 dark:text-zinc-300 text-[11px] sm:text-xs">
                        {phone2 ? phone2.ptaTax.taxSlab : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
              ...
              <div className="rounded-2xl sm:rounded-3xl bg-white dark:bg-white/5 dark:backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-2xl overflow-hidden">
                ...
                <div className="p-3 sm:p-5 space-y-3 sm:space-y-4">
                  ...
                  <div className="border-b border-gray-200 dark:border-white/10 pb-3">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 font-semibold text-gray-900 dark:text-white text-[11px] sm:text-xs leading-relaxed">
                        {phone1 ? phone1.specs.processor : '-'}
                      </div>
                      <div className="px-2 font-semibold text-gray-900 dark:text-white text-[11px] sm:text-xs leading-relaxed">
                        {phone2 ? phone2.specs.processor : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-b border-gray-200 dark:border-white/10 pb-3">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 text-gray-800 dark:text-zinc-200 font-mono text-[11px] sm:text-xs">
                        {phone1 ? phone1.specs.ram : '-'}
                      </div>
                      <div className="px-2 text-gray-800 dark:text-zinc-200 font-mono text-[11px] sm:text-xs">
                        {phone2 ? phone2.specs.ram : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-b border-gray-200 dark:border-white/10 pb-3">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      ...
                      <div className="px-2 text-gray-800 dark:text-zinc-200 font-mono text-[11px] sm:text-xs">
                        {phone2 ? phone2.specs.storage : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pb-1">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      ...
                      <div className="px-2 text-gray-700 dark:text-zinc-300 text-[11px] sm:text-xs">
                        {phone2 ? phone2.specs.os : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-3 sm:p-5 space-y-3 sm:space-y-4">
                  ...
                  <div className="border-b border-gray-200 dark:border-white/10 pb-3">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      ...
                      <div className="px-2 font-semibold text-gray-900 dark:text-white text-[11px] sm:text-xs leading-relaxed">
                        {phone2 ? phone2.specs.display : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pb-1">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 text-emerald-700 dark:text-emerald-400 font-bold text-[11px] sm:text-xs">
                        {phone1 ? phone1.specs.refreshRate : '-'}
                      </div>
                      <div className="px-2 text-emerald-700 dark:text-emerald-400 font-bold text-[11px] sm:text-xs">
                        {phone2 ? phone2.specs.refreshRate : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
              ...
              <div className="rounded-2xl sm:rounded-3xl bg-white dark:bg-white/5 dark:backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-2xl overflow-hidden">
                ...
                <div className="p-3 sm:p-5 space-y-3 sm:space-y-4">
                  ...
                  <div className="border-b border-gray-200 dark:border-white/10 pb-3">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 text-gray-900 dark:text-zinc-200 font-medium text-[11px] sm:text-xs leading-relaxed">
                        {phone1 ? phone1.specs.mainCamera : '-'}
                      </div>
                      <div className="px-2 text-gray-900 dark:text-zinc-200 font-medium text-[11px] sm:text-xs leading-relaxed">
                        {phone2 ? phone2.specs.mainCamera : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pb-1">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 text-gray-900 dark:text-zinc-200 text-[11px] sm:text-xs leading-relaxed">
                        {phone1 ? phone1.specs.selfieCamera : '-'}
                      </div>
                      <div className="px-2 text-gray-900 dark:text-zinc-200 text-[11px] sm:text-xs leading-relaxed">
                        {phone2 ? phone2.specs.selfieCamera : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
              ...
              <div className="rounded-2xl sm:rounded-3xl bg-white dark:bg-white/5 dark:backdrop-blur-xl border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-2xl overflow-hidden">
                ...
                <div className="p-3 sm:p-5 space-y-3 sm:space-y-4">
                  ...
                  <div className="border-b border-gray-200 dark:border-white/10 pb-3">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 text-emerald-700 dark:text-emerald-400 font-bold font-mono text-[11px] sm:text-xs">
                        {phone1 ? phone1.specs.battery : '-'}
                      </div>
                      <div className="px-2 text-emerald-700 dark:text-emerald-400 font-bold font-mono text-[11px] sm:text-xs">
                        {phone2 ? phone2.specs.battery : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pb-1">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-white/10 text-center">
                      <div className="px-2 text-gray-900 dark:text-zinc-200 text-[11px] sm:text-xs">
                        {phone1 ? phone1.specs.charging : '-'}
                      </div>
                      <div className="px-2 text-gray-900 dark:text-zinc-200 text-[11px] sm:text-xs">
                        {phone2 ? phone2.specs.charging : <span className="text-xs text-gray-400 dark:text-zinc-600 font-normal italic">-</span>}
                      </div>
                    </div>
                  </div>
